...
* Spells
  ...
  | # |      21 |     9 |       |             |             2 |      |             |
  |---+---------+-------+-------+-------------+---------------+------+-------------|
  #+TBLFM: @2$2..@>$2=10+$3+$6::@2$6..@>$6='(let ((stat remote(CastingStat, @1$2))) (cond ((string= stat "Int") remote(Stats, @5$Modifier)) ((string= stat "Wis") remote(Stats, @6$Modifier)) ((string= stat "Cha") remote(Stats, @7$Modifier))))::@3$4=if($5 > 0, max(0, ($6-$3)\4+1+$5), string(""))
  ...
  | # | Concentration |     4 |    2 |       2 |      |
  |---+---------------+-------+------+---------+------|
  #+TBLFM: @2$3=vsum($4..$6)::@2$4=remote(CasterLevel, @1$2)::@2$5='(let ((stat remote(CastingStat, @1$2))) (cond ((string= stat "Int") remote(Stats, @5$Modifier)) ((string= stat "Wis") remote(Stats, @6$Modifier)) ((string= stat "Cha") remote(Stats, @7$Modifier))))
